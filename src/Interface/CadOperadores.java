...
import Utils.OperadorTableModel;
import VO.Operador;
 ...
 * @author Luan
 */
public class CadOperadores extends javax.swing.JDialog {
    ...
    private void setCadastrando(boolean cadastrando) {
        ...
        txtLogin.setEnabled(cadastrando);
    ...
    private void atualizarTabela() {
        OperadorTableModel tabela = (OperadorTableModel)(tbDados.getModel());
        tabela.setDados(operadorController.getListOperador(txtBuscar.getText()));
     ...
     */
    public CadOperadores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        tbDados.setModel(new OperadorTableModel());
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        if(tbDados.getSelectedRowCount() != 0){
            setCadastrando(true);
            OperadorTableModel tabela = (OperadorTableModel)(tbDados.getModel());
            Operador selected = (Operador)tabela.getDados().get(tbDados.getSelectedRow());
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if(tbDados.getSelectedRowCount() != 0){
            OperadorTableModel tabela = (OperadorTableModel)(tbDados.getModel());
            Operador selected = (Operador)tabela.getDados().get(tbDados.getSelectedRow());
            operadorController.delete(selected);
            setClean();
            atualizarTabela();
        }
